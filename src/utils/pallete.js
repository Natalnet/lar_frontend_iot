export const Primary = { 0: '#008FD6', 200: '#007BC2', 400: '#0067AE' };

export const Violet = { 0: '#941E82', 200: '#800A6E', 400: '#6C005A' };

export const Red = { 0: '#E74C3C', 200: '#D33828', 400: '#BF2414' };

export const Green = { 0: '#27AE60', 200: '#139A4C', 400: '#008638' };
